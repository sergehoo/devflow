...
urlpatterns += [
    ...
    path("recordings/<int:recording_pk>/regenerate-summary/",
         _recording_views.RecordingRegenerateSummaryView.as_view(),
         name="recording_regenerate_summary"),
    ...
    path("meetings/<int:pk>/minutes.pdf",
         _meeting_dashboard_view.MeetingMinutesPDFView.as_view(),
         name="meeting_minutes_pdf"),
    path("meetings/decisions/",
         _meeting_dashboard_view.MeetingDecisionListView.as_view(),
         name="meeting_decisions_list"),
    path("recordings/<int:recording_pk>/convert-suggestion/",
         _meeting_dashboard_view.RecordingConvertSuggestionView.as_view(),
    ...
    path("billing/invoices/<int:pk>/docx/", InvoiceDocxView.as_view(), name="invoice_docx"),
    ...
    # ════════════════════════════════════════════════════════════════
    # PR5-PR8 + PR16-PR21 — Méthodologies (placées ICI car les imports
    # _meth_views / _meth_admin sont après le 1er urlpatterns)
    # ════════════════════════════════════════════════════════════════
